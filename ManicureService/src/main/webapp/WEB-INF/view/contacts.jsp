...
<t:mainLayout title="Contacts">
    ...
    <div class="contact-form">
        ...
        <div class="containerContacts">
            <div class="block">
                <img class="contacts" src="/manicure/images/телефон.png" alt="Картинка телефона">
                <div class="text">+79534862110</div>
            </div>
            <div class="block">
                <img class="contacts" src="/manicure/images/почта.png" alt="Картинка почты">
                <div class="text">manicurekonechnomojno@icloud.com</div>
            </div>
            <div class="block">
                <img class="contacts" src="/manicure/images/вк.png" alt="Картинка вк">
                <div class="text">КонечноМожно</div>
            </div>
            <div class="block">
                <img class="contacts" src="/manicure/images/инста.png" alt="Картинка инстаграмма">
